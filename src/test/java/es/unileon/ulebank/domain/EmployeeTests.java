...
public class EmployeeTests {
	...
	public void setUp() throws MalformedHandlerException{
		...
		oneOffice = new Office("Encina", "Paseo San Antonio", 987400001, 24401, null, oneIdOffice);
		anotherOffice = new Office("Leon", "Plaza Espolol", 987402051, 24007, null, anotherIdOffice);
	...
	public void testSetIdOffice() throws MalformedHandlerException {
		...
		Office office = new Office("Ladreda", "Calle Fernandez Ladreda", 989001454, 24005, null, idOffice);
